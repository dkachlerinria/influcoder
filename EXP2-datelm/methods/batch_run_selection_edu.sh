...
# Usage: bash methods/batch_run_selection_edu.sh

# Define the base parameters from edu_pretrain.yaml
base_train_data_dir="/data/group_data/cx_group/data/fineweb/train/0"
base_metrics_dir="/data/group_data/cx_group/data/fineweb/train/0/edu"
metrics_file="metrics.npy"
metrics_path="${base_metrics_dir}/${metrics_file}"
metrics_format="npy"
base_output_dir="/data/group_data/cx_group/data/fineweb/train/0/edu_lambada_pythia1b_step10000"
