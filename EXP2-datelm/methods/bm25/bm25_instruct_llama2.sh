...
CUDA_VISIBLE_DEVICES=0 python -m methods.bm25.bm25_instruct \
      --train_data_dir /data/hf_cache/datasets/lsds_data/data/training_data/training_data/tulu_v2_unfiltered_data_dedup.jsonl \
      --val_dataset_name ${VAL_DATASET} \
      --val_num_samples 100 \
      --subset_size 200000 \
      --out_dir ${OUT_DIR}/${VAL_DATASET}_bm25_llama2.npy \
