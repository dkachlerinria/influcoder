...
#SBATCH --job-name=instruct_array_hf
#SBATCH --gres=gpu:L40S:1                
#SBATCH --output=logs/probe_gradsim_%A_%a.out
#SBATCH --error=logs/probe_gradsim_%A_%a.err
#SBATCH --ntasks=1
...
# ### Run the task
### NEED to change params, base_model_name, lora_ckpt
CUDA_VISIBLE_DEVICES=0 python -m methods.gradsim.probe_gradient_similarity_instruct_hf \
      ...
      --out_dir ${OUT_DIR}/${VAL_DATASET}_gradsim_hf.npy \
      --subset_size 200000 \
