...
# Usage: bash methods/batch_run_selection_bm25.sh

# Define the base parameters from bm25_pretrain.yaml
base_train_data_dir="/data/group_data/cx_group/data/fineweb/train/0"
base_metrics_dir="/data/group_data/cx_group/data/fineweb/train/0/bm25"
metrics_file="metrics.npy"
metrics_path="${base_metrics_dir}/${metrics_file}"
metrics_format="npy"
base_output_dir="/data/group_data/cx_group/data/fineweb/train/0/bm25_lambada_pythia1b_step10000"
