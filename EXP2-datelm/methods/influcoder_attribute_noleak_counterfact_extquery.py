...
MAX_LEN = 1024
PROJ_DIM = 8192
N_EXT_ANCHORS = 300   # external "practice queries" -- ~4.5x the 66 real ref
                      # queries, for a more diverse generalization signal
N_TEACHER_TRAIN = 500
N_EVAL_TRAIN = 250
EPOCHS = 8
HARD_RATIO = 0.5
...
SAVE_PATH = Path("results/factual-attribution-influcoder-noleak-extquery/InfluCoder.pt")
