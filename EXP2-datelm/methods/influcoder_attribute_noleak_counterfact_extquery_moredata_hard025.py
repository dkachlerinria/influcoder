...
HARD_RATIO 0.5 -> 0.25. Sample counts (900 anchors/2000 candidates/500 eval),
...
HARD_RATIO = 0.25      # ONLY CHANGE vs. the moredata baseline (was 0.5) -- sweep point
LR = 5e-5
SEED = 0
SELECT_BEST_ON = "aggregated"

SAVE_PATH = Path("results/factual-attribution-influcoder-noleak-extquery-moredata-hard025/InfluCoder.pt")
