...
# Usage: sbatch train/batch_run_pretrain_repsim.sh
...
data_paths=(
    "/data/group_data/cx_group/data/fineweb/train/0/repsim_lambada_pythia1b_step10000_gumbel_0.1"
    "/data/group_data/cx_group/data/fineweb/train/0/repsim_lambada_pythia1b_step10000_gumbel_0.5"
    "/data/group_data/cx_group/data/fineweb/train/0/repsim_lambada_pythia1b_step10000_gumbel_1.0"
    "/data/group_data/cx_group/data/fineweb/train/0/repsim_lambada_pythia1b_step10000_gumbel_2.0"
)
...
for data_path in "${data_paths[@]}"; do
  ...
  out_dir="${base_out_dir}/repsim_gumbel_${gumbel_temp}"
  ...
  if [ $? -eq 0 ]; then
    ...
    python3 evaluation/evaluate.py \
      ...
      --batch_size 4 \
      --tasks "$tasks" \
      --out_dir "out/repsim_gumbel_${gumbel_temp}" \
