...
# Usage: sbatch train/batch_run_pretrain_bm25.sh
...
data_paths=(
    "/data/group_data/cx_group/data/fineweb/train/0/bm25_lambada_pythia1b_step10000_gumbel_0.1"
    "/data/group_data/cx_group/data/fineweb/train/0/bm25_lambada_pythia1b_step10000_gumbel_0.5"
    "/data/group_data/cx_group/data/fineweb/train/0/bm25_lambada_pythia1b_step10000_gumbel_1.0"
    "/data/group_data/cx_group/data/fineweb/train/0/bm25_lambada_pythia1b_step10000_gumbel_2.0"
)
...
for data_path in "${data_paths[@]}"; do
  ...
  out_dir="${base_out_dir}/bm25_gumbel_${gumbel_temp}"
  ...
  if [ $? -eq 0 ]; then
    ...
    python3 evaluation/evaluate.py \
      ...
      --batch_size 4 \
      --tasks "$tasks" \
      --out_dir "out/bm25_gumbel_${gumbel_temp}" \
